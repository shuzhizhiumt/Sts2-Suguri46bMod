...
public class Nanako_BitPower : ModPowerTemplate
{
    ...
    {
        if (Owner.Player!=null && participants.Contains(base.Owner) && SecondaryResourceCmd.Get(Owner.Player, ModResources.OJStarId) >= base.DynamicVars["Additional_Payment"].BaseValue)
        {
