...
public class Holy_Night : ModCardTemplate
{
    ...
    {
        await PowerCmd.Apply<Holy_NightPower>(choiceContext, base.Owner.Creature, base.DynamicVars["Power"].BaseValue, base.Owner.Creature, this);
    }
